...
1. If you haven't already, download and install Fiji from https://fiji.sc. Download the latest Fiji for the Mars-Latest update site. For backwards compatibility, the Mars update site can be used, but is no longer updates and only supports Fiji stable with Java 8.
